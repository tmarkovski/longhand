...
private let entries: [(Character, Int32)] = [
...
let charToId: [Character: Int32] = Dictionary(uniqueKeysWithValues: entries)

/// Every printable character the model can write.
public let calligrapherAlphabet: [Character] = entries.map(\.0)
