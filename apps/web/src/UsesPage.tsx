    ...
    <main className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-4 py-7 sm:px-6 sm:py-10">
      <header className="flex flex-col gap-5">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            six examples, each generated by the engines. watch one write, open it in the
            studio to change it, or copy the code that reproduces it in your own app on web,
            iOS, or Android.
          </p>
        </div>
      </header>
      ...
      <Section title="a take is data">
        <p className="text-sm text-muted-foreground">
          ...
          draw the same strokes on every platform. That makes a take portable: derive the
          seed from a user id and each user gets their own consistent hand; pin a style and
          seed and the same signature renders on web, iOS, and Android; or send the numbers
          themselves, a few dozen bytes, and the receiving device draws the ink natively
          instead of playing a video. The{" "}
